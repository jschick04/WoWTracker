...
public class IdentityManager : IIdentityManager
{
    ...
    public async Task<AuthenticationResponse> AuthenticateAsync(AuthenticationRequest request, string? ipAddress)
    {
        ...
        if (!user.IsVerified) { throw new Exception("Email not confirmed"); }
    ...
    public Task ValidateResetTokenAsync(TokenRequest request)
    {
        return _data.Users.SingleOrDefaultAsync(
