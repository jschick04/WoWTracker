...
namespace TrackerApi.Library.Helpers {
    ...
    public class Result<T> : Result, IResult<T> {
        ...
        public new static Result<T> Fail(string message) =>
            new Result<T> { Succeeded = false, Messages = new List<string> { message } };

        public new static Result<T> Fail(List<string> messages) =>
            new Result<T> { Succeeded = false, Messages = messages };
        ...
        public new static Result<T> Success(string message) =>
            new Result<T> { Succeeded = true, Messages = new List<string> { message } };

        public static Result<T> Success(T data) => new Result<T> { Succeeded = true, Data = data };

        public static Result<T> Success(T data, string message) =>
            new Result<T> { Succeeded = true, Data = data, Messages = new List<string> { message } };

        public static Result<T> Success(T data, List<string> messages) =>
            new Result<T> { Succeeded = true, Data = data, Messages = messages };
